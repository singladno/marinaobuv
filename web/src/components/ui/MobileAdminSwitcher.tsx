  ...
  return (
    <>
      ...
      {isOpen && !whatsAppOpen && (
        <button
          type="button"
          className="fixed inset-0 z-[109] bg-black/45 backdrop-blur-[3px]"
          onClick={closeMenu}
      ...
      <div className="pointer-events-none relative isolate z-[120] overflow-visible">
        <div className="pointer-events-auto relative h-10 w-10 overflow-visible">
          ...
          <div className="absolute -right-1 -top-1 z-[45] flex h-4 w-4 items-center justify-center rounded-full border border-white/30 bg-violet-900/90 text-[9px] font-bold text-white shadow-sm">
