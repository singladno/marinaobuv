...
export function AdminPortalSwitcherHeader() {
  ...
  return (
    <div className="relative">
      ...
      {/* Menu Items */}
      <div
        className={`absolute right-0 top-full z-50 mt-2 space-y-2 transition-all duration-300 ${
          isOpen
      ...
      >
        {isOnAdmin ? (
          // Show only Customer portal when currently on admin
          <Link
            href="/"
            onClick={closeMenu}
          ...
          >
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gray-100 group-hover:bg-gray-200">
              <svg
      ...
      <button
        onClick={toggleMenu}
        className="group relative flex h-8 w-8 items-center justify-center rounded-full border border-gray-200 bg-white text-gray-700 shadow-lg transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
