    ...
    <>
      ...
      >
        ...
        {images.length > 1 && (
          <>
            <button
              className="swiper-button-prev-custom absolute left-2 top-1/2 z-10 h-8 w-8 -translate-y-1/2 rounded-full bg-black/20 p-1 text-white transition-all hover:bg-black/30 focus:outline-none focus:ring-2 focus:ring-white/50"
            ...
            <button
              className="swiper-button-next-custom absolute right-2 top-1/2 z-10 h-8 w-8 -translate-y-1/2 rounded-full bg-black/20 p-1 text-white transition-all hover:bg-black/30 focus:outline-none focus:ring-2 focus:ring-white/50"
