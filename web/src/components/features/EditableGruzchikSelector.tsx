...
export function EditableGruzchikSelector({
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && !disabled && (
        <div className="absolute right-0 top-full z-50 mt-1 min-w-[200px] rounded-md border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800">
          <div className="py-1">
            <button
              type="button"
