  ...
  return (
    <thead className="bg-gray-50 dark:bg-gray-800">
      <tr>
        ...
        <th className="w-64 border-b border-gray-200 px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:border-gray-700 dark:text-gray-400">
          Пол
        </th>
        <th className="w-64 border-b border-gray-200 px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 dark:border-gray-700 dark:text-gray-400">
          Сезон
