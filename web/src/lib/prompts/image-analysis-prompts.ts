...
- Создавайте описание товара из ДВУХ ЧАСТЕЙ:
  ...
  2) МАРКЕТИНГОВОЕ ПРЕДЛОЖЕНИЕ (краткое, красивое описание)
...
- ВСЕГДА определяйте основной цвет обуви
...
Вместо <Маркетинговое предложение> используйте красивое описание товара.

ЗИМНИЕ ПРИМЕРЫ:
- "Женские зимние сапоги с мехом. Элегантный дизайн."
- "Мужские зимние угги. Теплая подкладка."
- "Детские зимние валенки. Удобная застежка."

ЛЕТНИЕ ПРИМЕРЫ:
- "Женские летние сандалии. Стильный дизайн."
- "Мужские летние шлепанцы. Легкие и удобные."
- "Детские летние босоножки. Яркие цвета."

ВЕСЕННИЕ ПРИМЕРЫ:
- "Женские весенние балетки. Классический стиль."
- "Мужские весенние кеды. Спортивный дизайн."
- "Детские весенние туфли. Удобная подошва."

ОСЕННИЕ ПРИМЕРЫ:
- "Женские осенние ботинки. Практичный дизайн."
- "Мужские осенние кроссовки. Удобная подошва."
- "Детские осенние мокасины. Мягкие материалы."

ПРИМЕРЫ ЧТО НЕ ДЕЛАТЬ (ЗАПРЕЩЕНО):
❌ НЕ КОПИРУЙТЕ: ниакие слова из сообщений WhatsApp
...
export const IMAGE_ANALYSIS_USER_PROMPT = (
  ...
  `Проанализируйте это изображение обуви и определите: 1) Точный тип обуви (сапоги/ботинки/туфли/кроссовки/сандалии/босоножки), 2) Пол (мужской/женский) по дизайну, 3) Сезон по стилю, 4) Основной цвет и дополнительные цвета (массив), 5) Материал по внешнему виду. Создайте точное название и описание на русском языке. Верните JSON с деталями товара.
