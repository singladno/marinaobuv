...
true — если из текста следует, что в упаковке намеренно разные цвета (например: «разные цвета в упаковке», «цвета разные», «в упаковке разные цвета», «микс цветов», «разноцветный набор», «12 пар (цвета разные)», «2 цвет», «3 цвет», «2 цвета»). «цвет 1» / «1 цвет» — false.
