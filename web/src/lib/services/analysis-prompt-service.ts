...
export class AnalysisPromptService {
  ...
  getSystemPrompt(): string {
    return `You are an expert at analyzing product information from text and images for a shoe store.
  ...
  getTextOnlySystemPrompt(): string {
    return `You are an expert at analyzing product information from text for a shoe store.
            Extract product details including name, price, gender, season, sizes, colors, category, and description.
