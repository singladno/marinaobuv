...
./prisma-server.sh npx prisma migrate resolve --applied 20200101000000_init 2>/dev/null || echo "Migration already resolved or doesn't exist"
./prisma-server.sh npx prisma migrate resolve --applied 20251002173621_add_is_purchased_to_order_item 2>/dev/null || echo "Migration already resolved or doesn't exist"
